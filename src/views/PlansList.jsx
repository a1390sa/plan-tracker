  ...
  const commit = async () => {
    ...
    try {
      ...
      parsed.indicators.forEach((i) => {
        ...
        i.tasks.forEach((t) => taskRows.push({ indicator_id: iid, month_no: t.month, description: t.desc, status: t.done ? "done" : "pending", task_kind: t.kind || "basic", completed_at: t.done ? new Date().toISOString() : null }));
      });
